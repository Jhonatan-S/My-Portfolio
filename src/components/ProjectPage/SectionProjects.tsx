        ...
        <section ref={ref} className='flex min-h-screen flex-col py-10 w-full gap-5 relative font-bold'>
            <MaxWidthContainer className="flex flex-col gap-10">
                <div className="flex flex-col gap-5">
                    <h1 className="text-center uppercase text-5xl bg-primary-color rounded-lg p-2 ">{t("titleProjects")}</h1>
                    <h2 className="text-center  bg-gray-400 p-3">{t("subtitleFreelance")}</h2>
                    ...
                    <div>
                        <h2 className="text-center  bg-gray-400 p-3">{t("subtitlePersonalProjects")}</h2>
                    </div>
                </div>
            </MaxWidthContainer>
        </section>
