...
export const Card = ({...props}: CardProps) => {
    ...
    return (
        <div
            ...
            className={`w-full max-w-[23rem] h-[13rem] sm:max-w-[26rem] md:max-w-[40rem] sm:h-[15rem] md:h-[23rem] border-2 border-primary-color rounded-md flex justify-center flex-col overflow-hidden relative`}>
                ...
                <div className={`${oswald.className} w-full h-full relative text-white flex flex-col justify-end p-3 md:p-10 gap-2 bg-[#0000005e]`}>
                    <div className='max-w-[23rem]'>
                        <motion.h2
                            ...
                            className='text-2xl font-bold uppercase'>{props.title}</motion.h2>
                        <p className={`${montserrat.className}`}>{props.description}</p>
                    </div>
                    <div className=''>
